...
<body>
<h3 style="text-decoration:none;">Add New Camp</h3>

<div>
  <form action="" method="post">
  <label for="date">Date</label><br>
    <input type="text" name="date" value="" placeholder="Date"><br>
    <label for="volume">Time</label><br>
    <input type="text" name="time" value="" placeholder="Time "><br>
    <label for="volume">Camp Name</label><br>
    <input type="text" name="cpname" value="" placeholder="Camp Name"><br>
    ...
    <input type="text"  name="cond" value="" placeholder="Conducted By"><br>
    <label for="volume">Organised By</label><br>
    <input type="text"  name="org" value="" placeholder="Organised By"><br>
   
   <input type="submit" name="insert" class="button" value="Submit">
  </form>
</div>
...
if(array_key_exists('insert', $_POST))
{
    ...
    $org=$_POST['org']; 
 echo $cpname;
$query="insert into camps values('','$date','$time','$cpname','$add','$state','$loc','$contact','$cond','$org')";
$data = mysqli_query($conn,$query);
if($data)
{
  
  echo "<script>alert('Data inserted successfully');window.location='admin_camps.php';</script>";
}
}

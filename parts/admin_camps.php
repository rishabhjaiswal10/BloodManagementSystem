...
.button:active {
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <a href="admin_camps.php" class="active">
...
padding-left:15px; padding-bottom:19px; background-color:#1b1b1b;">Camps</h1><br>
...
if($total!=0)
{
    ...
    {?>
        <tr>
        <td> <?php $result['camp_id']; echo $c++;?> </td>
        <td> <?php echo $result['Date'];?> </td>
        <td> <?php echo $result['Time'];?> </td>
        <td> <?php echo $result['Camp_Name'];?> </td>
        <td> <?php echo $result['Address'];?> </td>
        <td> <?php echo $result['State'];?> </td>
        <td> <?php echo $result['District'];?> </td>
        <td> <?php echo $result['Contact'];?> </td>
        <td> <?php echo $result['Conducted_By'];?> </td>
        <td> <?php echo $result['Organised_By'];?> </td>
        <td><a href="admin_camps_update.php?id=<?php echo $result['camp_id'];?>"><button class='button'>Update</button></a></td>
        <td><a href="camps_delete.php?id=<?php echo $result['camp_id'];?>"><button class='button'>Delete</button></a></td>
